...
import AirdropToken from './pages/AirdropToken';
...
function App() {
  ...
  return (
    ...
    //                   <img src={excel} alt="" style={{ width: '40px' }} />{' '}
    //                   Export{' '}
    //                 </button>
    //               </div>
    ...
    //                 <ol>
    //                   2. Please mention{' '}
    //                   <strong>Denomination in Lamports</strong> of the token.
    //                   Solana max supports 1-9
    //                 </ol>
    //                 <ol>
    //                   3. Please upload the <strong>excel</strong> in below
    //                   format only.
    ...
    //         <div
    //           className="flex flex-col justify-center align-middle content-center"
    //           style={{ height: '100%' }}
    //         >
    //           <div className="heading">Airdrop As A Service</div>
    //           <div className="subHeading">
    //             Now doing it, is as simple as sipping a coffee !!!
    //           </div>
    //           <div className="subSubHeading">
    //             You can airdrop SOL or any custom SOLANA SPL token with this
    //             service.
    //           </div>
